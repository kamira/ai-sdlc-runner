...
1. The relevant `docs/changes/CHG-*.md` — its **User stories** first (each story is checked off as a criterion; Skill >= v1.19 records carry them), then the modification guide and goal (when verifying a specific change)
